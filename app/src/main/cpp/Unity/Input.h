...
namespace Unity
{
    namespace Input
    {
        ...
        void Setup()
        {
            Input = BNM::LoadClass(OBFUSCATES_BNM("UnityEngine"), OBFUSCATES_BNM("Input"));
            GetTouch = Input.GetMethodByName(OBFUSCATES_BNM("GetTouch"), 1);
            GetMouseButtonDown = Input.GetMethodByName(OBFUSCATES_BNM("GetMouseButtonDown"), 1);
