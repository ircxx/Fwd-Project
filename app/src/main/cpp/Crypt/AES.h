...
class AES {
 private:
  ...
  static void ShiftRow(unsigned char **state, int i,
  ...
  static void AddRoundKey(unsigned char **state, const unsigned char *key);

  static void SubWord(unsigned char *a);

  static void RotWord(unsigned char *a);

  static void XorWords(const unsigned char *a, const unsigned char *b, unsigned char *c);

  static void Rcon(unsigned char *a, int n);

  static void KeyExpansion(const unsigned char key[], unsigned char w[]);

  static void EncryptBlock(const unsigned char in[], unsigned char out[],
                    unsigned char key[]);

  static void XorBlocks(const unsigned char *a, const unsigned char *b,
                 unsigned char *c, unsigned int len);

  static std::vector<unsigned char> ArrayToVector(unsigned char *a, unsigned int len);
